...
{
    public abstract class AdibiWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AdibiWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AdibiWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AdibiDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AdibiDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AdibiDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AdibiDbContext, Task<T>> func)
        {
            T result;
