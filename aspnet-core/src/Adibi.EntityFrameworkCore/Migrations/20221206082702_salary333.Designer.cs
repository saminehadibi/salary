...
namespace Adibi.Migrations
{
    ...
    [Migration("20221206082702_salary333")]
    partial class salary333
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Adibi.Salareis.Salary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Adibi.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Adibi.Authorization.Users.User", null)
                        .WithMany("Claims")
